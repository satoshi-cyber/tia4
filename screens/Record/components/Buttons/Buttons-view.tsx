  ...
  if (lastSlide) {
    return (
      <>
        ...
        <p className="absolute w-[50vw] lg:w-[400px] z-10 text-2xl md:text-3xl text-gray-100 text-center pointer-events-none drop-shadow-md transform-gpu top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
