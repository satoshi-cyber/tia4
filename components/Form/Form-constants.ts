export const FORM_THEME = {
  default: {
    width: "w-full",
    container:
      "transition-all group mb-4 border border-gray-300 shadow-sm flex items-stretch rounded-md overflow-hidden group-data-[error=true]/wrapper:border-red-600 focus-within:border-purple-800 focus-within:shadow-hover",
