        ...
        <div>
          <button
            ...
            className={clsx(
              ...
              className,
              'transition-all p-1 border border-gray-200 text-gray-800 hover:text-purple-800 hover:border-gray-100 hover:shadow-icon flex items-center justify-center',
