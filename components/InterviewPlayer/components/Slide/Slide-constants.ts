export const CLASS_NAMES = {
    ...
    questionContianer: "absolute z-20 transform-gpu flex flex-col items-center backdrop-blur-2xl bg-black/20 rounded-lg p-3 m-3 md:max-w-[500px]",
    question: "text-md text-white text-center pointer-events-none transition-all transform-gpu duration-700",
    player: "shadow-sm overflow-hidden z-10"
}
