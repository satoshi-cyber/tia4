    ...
    >
      <defs>
        <linearGradient
          ...
          id={id}
        >
          <stop stopColor="#6B46C1" offset="0%"></stop>
          <stop stopColor="#44337A" offset="0.0655594406%"></stop>
          <stop stopColor="#A755F6" offset="100%"></stop>
        </linearGradient>
      </defs>
          ...
          <ActiveLink href={URLS.JOBS} shallow>
            <a className="text-md pl-5 py-1 mb-1 flex flex-row items-center text-gray-500 group/link hover:text-gray-800 cursor-pointer transition-all border-r-2 border-r-transparent data-[active=true]:border-purple-800">
              <Icon
                name="HiPlusCircle"
                size={28}
                className="m-0.5  group-data-[active=true]/link:text-purple-800 group-data-[active=true]/link:text-purple-800 text-gray-500 group-hover/link:text-purple-800"
              />
          ...
          <ActiveLink href={URLS.RATE} shallow>
            <a className="text-md pl-5 py-1 mb-1 flex flex-row items-center text-gray-500 group/link hover:text-gray-800 cursor-pointer transition-all border-r-2 border-r-transparent data-[active=true]:border-purple-800">
              <Icon
                name="HiPlay"
                size={28}
                className="m-0.5 group-data-[active=true]/link:text-purple-800 text-gray-500 group-hover/link:text-purple-800"
              />
              <span className="ml-5 transition-all absolute w-[240px] left-[40px] md:left-[69px] group-hover:left-[40px]">
                Rate
              </span>
